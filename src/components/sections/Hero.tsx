  ...
  return (
    <section className="pt-32 pb-20 px-4 relative overflow-hidden">
      <div className="container mx-auto text-center relative">
        <h1 className="text-5xl md:text-7xl font-bold mb-8 animate-fadeIn" style={{ animationDelay: "0.2s" }}>
        ...
        <p className="text-2xl md:text-3xl text-muted-foreground mb-10 max-w-3xl mx-auto animate-fadeIn" style={{ animationDelay: "0.4s" }}>
